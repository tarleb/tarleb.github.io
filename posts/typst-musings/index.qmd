...
Lua, which is established but flexlible, would have worked well
...
Notebooks are great tool to improve reproducibility in science
...
them them well suited for scientific writing in fields like
...
on a Typst pandoc writer, which will allow to convert existing
...
and even collaborative styling of PDFs*. That feature is truely
...
tech choices help attract contributors. Last but not least, the
app is shiny, works well, and makes people want to use it.
...
contained to very technical circles, and scientists don't have
strong reasons to switch yet. To the contrary, journals expect
paper submissions to be done in Word or LaTeX, not PDF. This won't
...
that I mentioned above. Regardless, I'm optimistic that there is a
business niche that it can occupy.

Either way, I hope that the Typst team's hard work will pay off,
and I will continue to follow their progress with great interest.
