...
like PDF/A-1a and PDF/UA that ensure that people with disabilities
can access the information contained in the PDF. This is currently
not supperted in Typst. LaTeX is still trying to catch up there,
too, while [ConTeXt] and [speedata] are doing well, for example.
