...
For example, [SciFlow], [Authorea], and [Overleaf] already exist,
cover most of the market needs, have a solid headstart, and are
well aligned with the need of science publishers and authors. Any
new tool has to compete with them. Also, let's not forget all the
other tools that I mentioned above.

Regardless, I'm optimistic that there is a business niche that
Typst can occupy. I hope that the Typst team's hard work will pay
off, and I will continue to follow their progress with great
interest.
