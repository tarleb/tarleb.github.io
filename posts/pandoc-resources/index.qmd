...
subtitle: An opinionated list
date: 2022-08-23
image: 'pandoc.png'
categories:
  - pandoc
description: |
  A list with resources that pandoc users may find useful.
---

In a world where I didn't know about [pandoc (the universal
document converter)](https://pandoc.org/), these would be the
resources that I'd like to have:
...
[latest release]: https://github.com/jgm/pandoc/release/latest
...
:   The [official pandoc manual][manual]. When in doubt, this
    ...
    something isn't working, you may want to update.

[FAQ](https://pandoc.org/faq.html)
...
:   Interface to that allows to write parsers for otherwise
    unsupported formats.

[Custom writers][writers]
:   Interface to that allows to use pandoc to convert to a custom
    output format.
